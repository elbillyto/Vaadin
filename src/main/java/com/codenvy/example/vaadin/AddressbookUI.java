...
public class AddressbookUI extends UI {
    ...
    private Button     addNewContactButton = new Button("Nuevo");
    private Button     removeContactButton = new Button("Eliminar contacto");
    private FormLayout editorLayout        = new FormLayout();
    private FieldGroup editorFields        = new FieldGroup();

    private static final String   FNAME      = "Nombre";
    private static final String   LNAME      = "Apellido";
    private static final String   COMPANY    = "Compañía";
    ...
    private void initSearch() {
        searchField.setInputPrompt("Buscar contacto");
    ...
    private void initAddRemoveButtons() {
        addNewContactButton.addClickListener(new ClickListener() {
            public void buttonClick(ClickEvent event) {
                ...
                contactList.getContainerProperty(contactId, FNAME).setValue("Nuevo");
                contactList.getContainerProperty(contactId, LNAME).setValue("Contacto");
    ...
    private static IndexedContainer createDummyDatasource() {
        ...
        String[] fnames = {"Peter", "Jane", "Eugene", "Max", "Perico"};
        String[] lnames = {"Smith", "Gordon", "Simpson", "Brown", "Palotes"};
